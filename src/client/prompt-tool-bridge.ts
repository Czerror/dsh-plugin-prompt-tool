...
export type BridgeResult<T> = { ok: true; value: T; providers?: string[]; modelCatalog?: Record<string, string[]>; activeSkillsDirs?: string[]; skillCatalog?: SkillCatalogEntry[]; templatePreStepCount?: number; presetParams?: Record<string, unknown>; moduleConfigs?: Record<string, Record<string, unknown>>; hostDefaultModel?: { provider?: string; model?: string; reasoningEffort?: string } } | BridgeErrorPayload
