...
export type BridgeResult<T> = { ok: true; value: T; deepseekProviders?: string[]; deepseekModels?: string[]; activeSkillsDirs?: string[]; skillCatalog?: SkillCatalogEntry[] } | BridgeErrorPayload
