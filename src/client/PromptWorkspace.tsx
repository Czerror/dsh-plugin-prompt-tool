 ...
 *  per-child shadow）、工具与深度（toolFilter / allowKinds / maxDepth）；主会话引擎
 *  模块（tool-bootstrap /
    ...
    : page === 'features'
      ...
      : page === 'presets'
        ...
        : page === 'characters'
          ...
          : '子代理作用域参数（模型/人设/工具集/深度）与子代理提示词配置（audience 非仅主会话；子代理独立人设 = 模型卡 subagentPersona，官方 per-child shadow 覆盖 deployment:persona，留空 = 继承主会话）。'
