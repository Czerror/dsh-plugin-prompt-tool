...
export interface PromptConfigListProps {
  ...
  /** 列表顶部内容资产卡（preset.md/agents.md 模块化卡片，始终显示）。 */
...
export function PromptConfigList(props: PromptConfigListProps): ReactNode {
  const { meta, configs, savedConfigs, layer, scope, extraActions, listHeader, emptyHint, onPatchConfigs, onSaveConfigs, onNotice } = props
