...
- 日期：2026-09-16。
- 状态：计划文档已完成并通过文档校验，业务代码尚未实施；任务状态见第 7 节。
...
- [ ] **执行 Wave 1：字段正确性（对应 W1，待用户授权）**
  - [ ] **ST-01**：修复 selective_logic 别名，完成红灯到绿灯及独立/内嵌格式回归。
  - [ ] **ST-02**：修复 use_probability 别名，锁定 false/0 与概率过滤语义。
  - [ ] 完成 T01/T02、每任务完整门禁及兼容文档同步，记录 Summary，提交并推送 origin/dev。
