...
- [ ] Wave 1 / T2、T3：未授权，未修复 V1/V2。
- [ ] Wave 2 / T4：未授权，未修复 V3。
- [ ] Wave 3 / T5—T8：未授权，未修复 N1/N2/V4/V5/V6。
- [ ] Wave 4 / T9：未授权；候选修复完成后执行，不用本次测试绿替代修复验收。
- PLAN 保留在 `.scratch/plan/`；两份 2026-09-20 归档原样保留。
