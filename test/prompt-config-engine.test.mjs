...
import { applyPromptConfigs, createPromptConfigs, inject, loadPromptConfigFiles, parsePromptConfigYaml } from '../preset/engine/prompt-config-engine.mjs'
...
test('createPromptConfigs 对未知 strategy 配置 fail loud', () => {
  assert.throws(() => createPromptConfigs([{ id: 'x', strategy: 'nope' }]), /unknown strategy/)
})
